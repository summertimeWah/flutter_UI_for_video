...
class FirebaseStoragePage {
  ...
  static Future<void> uploadObject(String userName, String fileName, Uint8List file) async {
    // 建立 reference 索引
    final storageRef = FirebaseStorage.instance.ref();

    // 指定目標 reference，將檔案存放在以使用者名稱命名的資料夾中
    final fileGoalRef = storageRef.child('$userName/$fileName');
